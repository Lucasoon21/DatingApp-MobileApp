                ...
                <View style={styles.scrollContainer}>
                    ...
                    <View style={styles.sectionContainer}>
                        ...
                        <RangeSlider min={18} max={100}
                            ...
                            initialFromValue={18}
                        />
                        <Text style={styles.subText}>Wiek od: {fromAge} do {toAge}</Text>
                    ...
                    <View style={styles.sectionContainer}>
                        ...
                        <View style={styles.pickerView}>
                            <Picker
                                ...
                                selectedValue={interestedSex}
                                onValueChange={(itemValue) => setInterestedSex(itemValue)}
                            >
                    ...
                    <View style={styles.sectionContainer}>
                        ...
                        />
                        <Text style={styles.subText}>Wzrost od: {fromHeight} do {toHeight}</Text>
                    </View>
                    ...
                    <View style={styles.sectionContainer}>
                        ...
                        <RangeSlider
                            ...
                            initialFromValue={50}
                        />
                        <Text style={styles.subText}>Wzrost od: {fromWeight} do {toWeight}</Text>
                    </View>
